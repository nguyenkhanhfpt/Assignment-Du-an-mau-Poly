    ...
    <table class="table ">
        ...
        <tbody>
            <?php foreach ($items as $item) : ?>
                <tr>
                    <th><input type="checkbox" name="ma_hh[]" value="<?= $item['ma_hh'] ?>"></th>
                    <td><?= $item['ma_hh'] ?></td>
                    <td><?= $item['ten_hh'] ?></td>
                    <td>$ <?= $item['don_gia'] ?></td>
                    <td><?= $item['giam_gia'] ?> %</td>
                    ...
                    <td>
                        <a href="index.php?btn-edit&ma_hh=<?= $item['ma_hh'] ?>" class="btn btn-default border">Sửa</a>
                        <a href="index.php?btn-delete&ma_hh=<?= $item['ma_hh'] ?>" class="btn btn-default border">Xóa</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
